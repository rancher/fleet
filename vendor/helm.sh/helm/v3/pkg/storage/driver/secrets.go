...
func (secrets *Secrets) Get(key string) (*rspb.Release, error) {
	...
	obj, err := secrets.impl.Get(context.TODO(), key, metav1.GetOptions{})
	if err != nil {
...
func (secrets *Secrets) List(filter func(*rspb.Release) bool) ([]*rspb.Release, error) {
	...
	list, err := secrets.impl.List(context.TODO(), opts)
	if err != nil {
...
func (secrets *Secrets) Create(key string, rls *rspb.Release) error {
	...
	if _, err := secrets.impl.Create(context.TODO(), obj, metav1.CreateOptions{}); err != nil {
...
func (secrets *Secrets) Update(key string, rls *rspb.Release) error {
	...
	// push the secret object out into the kubiverse
	_, err = secrets.impl.Update(context.TODO(), obj, metav1.UpdateOptions{})
...
func (secrets *Secrets) Delete(key string) (rls *rspb.Release, err error) {
	...
	// delete the release
	err = secrets.impl.Delete(context.TODO(), key, metav1.DeleteOptions{})
	return rls, err
}
