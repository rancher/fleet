...
replace (
	...
	k8s.io/cri-client => k8s.io/cri-client v0.33.12
	...
	k8s.io/endpointslice => k8s.io/endpointslice v0.33.12
	k8s.io/externaljwt => k8s.io/externaljwt v0.33.12
	k8s.io/kms => k8s.io/kms v0.33.12
	...
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.33.12
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.33.12
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.33.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.33.12
)
