...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in HelmFilters) DeepCopyInto(out *HelmFilters) {
	{
		in := &in
		*out = make(HelmFilters, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelmFilters.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HelmTest) DeepCopyInto(out *HelmTest) {
	*out = *in
	if in.Timeout != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HelmTest.
func (in *HelmTest) DeepCopy() *HelmTest {
	if in == nil {
		return nil
	}
	out := new(HelmTest)
