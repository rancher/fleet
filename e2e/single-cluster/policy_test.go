...
// Tests for Policy CRD enforcement across GitRepo and Bundle reconcilers.
// Runs against the single-cluster (fleet-local) setup.
//
// All fleet resources (GitRepo, Policy, SA) are created in env.Namespace
...
//  6. Multiple Policies: OR semantics for requireServiceAccount.
//  7. Bundle: direct fleet-apply bypass is blocked by Policy.
