...
func New(controllerManager *generic.ControllerManager, client clientset.GitopsV1Interface,
...
type version struct {
	...
	client            clientset.GitopsV1Interface
}

func (c *version) GitJob() GitJobController {
	return NewGitJobController(v1.SchemeGroupVersion.WithKind("GitJob"), c.controllerManager, c.client, c.informers.GitJobs())
}
