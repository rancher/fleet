...
import (
	v1alpha1 "github.com/rancher/fleet/pkg/generated/clientset/versioned/typed/fleet.cattle.io/v1alpha1"
...
func (c *FakeFleetV1alpha1) ClusterGroupTokens(namespace string) v1alpha1.ClusterGroupTokenInterface {
	return &FakeClusterGroupTokens{c, namespace}
}

func (c *FakeFleetV1alpha1) ClusterRegistrationRequests(namespace string) v1alpha1.ClusterRegistrationRequestInterface {
	return &FakeClusterRegistrationRequests{c, namespace}
}
