...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FleetGlobalValues) DeepCopyInto(out *FleetGlobalValues) {
	*out = *in
	if in.ClusterLabels != nil {
		in, out := &in.ClusterLabels, &out.ClusterLabels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FleetGlobalValues.
func (in *FleetGlobalValues) DeepCopy() *FleetGlobalValues {
	if in == nil {
		return nil
	}
	out := new(FleetGlobalValues)
	in.DeepCopyInto(out)
	return out
}
