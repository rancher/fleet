...
type FleetYAML struct {
	...
	// ImageScans are used to update container image references in the git
	// repo. The fleet.yaml optionally contains an imageScans: section.
	ImageScans []ImageScanYAML `json:"imageScans,omitempty"`
	// OverrideTargets overrides targes that are defined in the GitRepo
