...
import (
	...
	"github.com/rancher/fleet/pkg/generated/clientset/versioned/scheme"
...
func (c *FleetV1alpha1Client) ClusterGroupTokens(namespace string) ClusterGroupTokenInterface {
	return newClusterGroupTokens(c, namespace)
}

func (c *FleetV1alpha1Client) ClusterRegistrationRequests(namespace string) ClusterRegistrationRequestInterface {
	return newClusterRegistrationRequests(c, namespace)
}
