...
import (
	...
	informers "github.com/rancher/gitjobs/pkg/generated/informers/externalversions"
...
func (c *Factory) Gitops() Interface {
	return New(c.controllerManager, c.informerFactory.Gitops(), c.clientset)
}
